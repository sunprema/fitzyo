...
#
#     PHX_SERVER=true bin/fitzyo start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :fitzyo, FitzyoWeb.Endpoint, server: true
end
  ...
  config :fitzyo, FitzyoWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/fitzyo_web/router\.ex$"E,
        ~r"lib/fitzyo_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
